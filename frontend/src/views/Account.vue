      ...
      <div class="top h-64 w-full bg-gray-900 overflow-hidden relative">
        <div class="flex flex-col justify-center items-center relative h-full text-white">
          <avatar
            ...
            :user="user"
          />
          <h1 class="text-2xl text-green-500 font-semibold uppercase">
            {{ user.pseudo }}
          </h1>
        </div>
      </div>
        ...
        <div class="col-span-12 w-full h-full pb-12 md:col-span-10">
          <div class="px-4 pt-4">
            <form class="flex flex-col space-y-8">
              ...
              <div>
                <h2 class="text-2xl text-white font-semibold">Mes informations</h2>
                <hr class="mt-2 border-green-500" />
              </div>
              <div class="form-item">
                <label class="text-xl text-white"
                  >Pseudonyme :
                  <span class="text-green-500">{{ user.pseudo }}</span></label
                >
                <input
                  v-model="newPseudo"
